;;; spacemacs-hotline-theme.el --- Custom version of spacemacs light theme to match desktop theme
...
(deftheme spacemacs-hotline)

(let ((class '((class color) (min-colors 89)))

   (bg1             "#171717")(comment-bg "#171717")
   (bg2             "#1d2026")(cblk-bg "#1d2026")(ttip-bg "#1d2026")(cblk-ln-bg "#1d2026")
   (bg3             "#363636")
   (bg4             "#464646")
   (base-dim        "#d3d1cb")(head1   "#d3d1cb")(ttip  "#d3d1cb")(cblk "#d3d1cb")
   (base            "#e8e6df")(str          "#e8e6df")
   (cyan            "#51e5ff")(const         "#51e5ff")
   (aqua            "#00e1ff")(meta          "#00e1ff")(border "#00e1ff")
   (aqua-bg         "#ff6666")(war           "#ff6666")(err "#ff6666")
   (green           "#00b094")(lnum          "#00b094")(cblk-ln  "#00b094")
   (green-bg        "#c9ff3a")(suc           "#c9ff3a")
   (green-bg-s      "#acbbcd")(highlight     "#acbbcd")(mat "#acbbcd")
   (blue            "#087ec6")(func          "#087ec6")
   (blue-bg         "#9fcecc")(ttip-sl       "#9fcecc")(comment "#9fcecc")
   (blue-bg-s       "#9bc8ff")(act2          "#9bc8ff")
   (magenta         "#bc00de")(cursor        "#bc00de")(type "#bc00de")(act1 "#bc00de")
   (red             "#ff66b3")(var           "#ff66b3")
   (red-bg          "#ffa9b8")(comp          "#ffa9b8")(highlight-dim "#ffa9b8")
   (red-bg-s        "#ff8a00")
   (yellow          "#ffba26")(keyword       "#ffba26")(mat "#ffba26")
   (yellow-bg       "#ff8a00")
...
;;;;; basics
     ...
     `(font-lock-preprocessor-face ((,class (:foreground ,cursor))))
...
;;;;; elfeed
     `(elfeed-search-date-face ((,class (:foreground ,head1))))
...
;;;;; org
     ...
     `(org-agenda-done ((,class (:foreground ,comment :strike-through t :height 1.0))))
     ...
     `(org-document-info-keyword ((,class (:foreground ,base-dim :height 0.8))))
     `(org-document-title ((,class (:inherit nil :family ,et-font :foreground ,base-dim :underline nil :height 2.5))))
     `(org-done ((,class (:foreground ,comment :background nil :strike-through t :family et-font))))
     `(org-ellipsis ((,class (:foreground ,comment :underline nil))))
     `(org-footnote  ((,class (:underline t :family ,et-font :slant italic :foreground ,act1))))
     ...
     `(org-level-6 ((,class (:inherit nil :foreground ,head1 :family ,et-font :weight normal :slant normal :height 1.3))))
     `(org-level-7 ((,class (:inherit nil :foreground ,head1 :family ,et-font :weight normal :slant normal :height 1.3))))
     `(org-level-8 ((,class (:inherit nil :foreground ,head1 :family ,et-font :weight normal :slant normal :height 1.3))))
     ...
     `(org-todo ((,class (:foreground ,type :inherit bold :background nil))))
...
(provide-theme 'spacemacs-dark-paradise)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; spacemacs-hotline-theme.el ends here

;;; Code:

(deftheme spacemacs-dark-paradise)

(let ((class '((class color) (min-colors 89)))

   (bg1             "#091f2c")
   (bg2             "#203a3e")(cblk-bg "#203a3e")(ttip-bg "#203a3e")(comment-bg "#203a3e")
   (bg3             "#3c3d39")(cblk-ln-bg "#3c3d39")
   (bg4             "#2f675c")
   (base-dim        "#f9f3f0")(head1   "#f9f3f0")(ttip  "#f9f3f0")(cblk "#f9f3f0")
   (base            "#fefef7")
   (cyan            "#108fb8")(const         "#108fb8")
   (aqua            "#bf3144")(meta          "#bf3144")
   (aqua-bg         "#e8544f")(war           "#e8544f")(err "#e8544f")
   (green           "#488776")(lnum          "#488776")(cblk-ln  "#488776")
   (green-bg        "#65a86f")(suc           "#65a86f")
   (green-bg-s      "#adbb6d")(highlight     "#adbb6d")(mat "#adbb6d")
   (blue            "#30a490")(func          "#30a490")
   (blue-bg         "#8abeb7")(ttip-sl       "#8abeb7")(comment "#8abeb7")
   (blue-bg-s       "#c9bdc4")(act2          "#c9bdc4")
   (magenta         "#d07c67")(cursor        "#d07c67")(type "#d07c67")
   (red             "#dd8f9f")(var           "#dd8f9f")
   (red-bg          "#e6aab4")(comp          "#e6aab4")(highlight-dim "#e6aab4")
...
;;; spacemacs-dark-paradise-theme.el ends here
